...
public class VRegEst extends javax.swing.JFrame {
    ...
    public VRegEst() {
        initComponents();
        modeloTabla = new DefaultTableModel(new String[]{"Nombres", "Apellidos", "DNI", "Edad"}, 0);
    ...
    private void initComponents() {
        ...
        txtBuscar.setMinimumSize(new java.awt.Dimension(64, 24));

        btnBuscar.setBackground(new java.awt.Color(13, 138, 146));
        btnBuscar.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        btnBuscar.setForeground(new java.awt.Color(255, 255, 255));
        btnBuscar.setText("BUSCAR");
        btnBuscar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 47, 75), 2, true));
        btnBuscar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnBuscar.setPreferredSize(new java.awt.Dimension(53, 30));
        ...
        btnGuardar.setBackground(new java.awt.Color(13, 138, 146));
        btnGuardar.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        btnGuardar.setForeground(new java.awt.Color(255, 255, 255));
        btnGuardar.setText("GUARDAR");
        btnGuardar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 47, 75), 2, true));
        ...
        btnEliminar.setBackground(new java.awt.Color(13, 138, 146));
        btnEliminar.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        btnEliminar.setForeground(new java.awt.Color(255, 255, 255));
        btnEliminar.setText("ELIMINAR");
        btnEliminar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 47, 75), 2, true));
        ...
        btnModificar.setBackground(new java.awt.Color(13, 138, 146));
        btnModificar.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        btnModificar.setForeground(new java.awt.Color(255, 255, 255));
        btnModificar.setText("MODIFICAR");
        btnModificar.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(42, 47, 75), 2, true));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (validarCampos()) {
            agregarEstudiante(txtNombre.getText(), txtApellido.getText(), txtDni.getText(), jDateChooser1.getDate());
            limpiarCampos();
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        eliminarEstudiante(txtDni.getText());
        limpiarCampos();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        List<Estudiante> estudiantesEncontrados = buscarEstudiantes(textoBuscar);
        if (!estudiantesEncontrados.isEmpty()) {
            ...
            for (Estudiante estudiante : estudiantesEncontrados) {
                mensaje.append(estudiante.getNombre()).append(" ").append(estudiante.getApellido())
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:        
        if (validarCampos()) {
            modificarEstudiante(txtDni.getText(), txtNombre.getText(), txtApellido.getText(), jDateChooser1.getDate());
            limpiarCampos();
        }
    ...
    private void TablaRegistroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaRegistroMouseClicked
        ...
        // Verificamos que una fila esté seleccionada
        if (filaseleccionada >= 0) {
            // Asignamos los valores de la fila a los campos de texto
            txtNombre.setText(modeloTabla.getValueAt(filaseleccionada, 0).toString());
            txtApellido.setText(modeloTabla.getValueAt(filaseleccionada, 1).toString());
            txtDni.setText(modeloTabla.getValueAt(filaseleccionada, 2).toString());
        } else {
    ...
    public void eliminarEstudiante(String dni) {
        ...
        if (estudiante != null) {
            ...
            eliminarEstudianteDeTabla(dni);
            JOptionPane.showMessageDialog(null, "Estudiante eliminado correctamente.");
        } else {
            JOptionPane.showMessageDialog(null, "Complete el campo con el DNI a eliminar.");
        }
    }
    ...
    public void modificarEstudiante(String dni, String nuevoNombre, String nuevoApellido, Date nuevaFechaNacimiento) {
        ...
        if (estudiante != null) {
            ...
            modificarEstudianteEnTabla(estudiante);
    ...
    public void agregarEstudianteATabla(Estudiante estudiante) {
        ...
        modeloTabla.addRow(new Object[]{estudiante.getNombre(), estudiante.getApellido(), estudiante.getDni(), edad});
    }
    ...
    public void modificarEstudianteEnTabla(Estudiante estudiante) {
        ...
        for (int i = 0; i < TablaRegistro.getRowCount(); i++) {
            if (modeloTabla.getValueAt(i, 2).equals(estudiante.getDni())) {
                ...
                modeloTabla.setValueAt(edad, i, 3);
                break;
            }
        }
    }
    ...
    private boolean validarCampos() {
        if (txtNombre.getText().isEmpty() || txtApellido.getText().isEmpty() || txtDni.getText().isEmpty() || jDateChooser1.getDate() == null) {
